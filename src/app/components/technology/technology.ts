import { Component, Inject, Output, EventEmitter, ViewEncapsulation, AfterViewInit } from 'angular2/core';
import { Router, RouteParams, RouterLink, Location } from 'angular2/router';

import { QuestionCard } from '../question-card/question-card';
import { IQuestion, Question, QuestionsStore, QUESTION } from '../../services/question-store/question-store';
...
export class Technology implements AfterViewInit {
  ...
  private toggle(choice) {console.log("tohhle")
